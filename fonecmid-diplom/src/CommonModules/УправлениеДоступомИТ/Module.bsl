//++ВКМ 28.02.2026 Салтанова
//разместила уже готовую процедуру в нужной области
...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	//++ ВКМ от 23.02.2026 (Салтанова)
	// Добавление дополнительных поставляемых профилей пользователей
	// Профиль "Специалист".
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	...
	ОписаниеПрофиля.Описание =
		НСтр("ru = 'Кадровик с функцией бухгалтера по расчету заработной платы и планированию отпусков'");
	ОписаниеПрофиля.Роли.Добавить("БазоваяФункциональностьТП");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РасчетЗарплатыИОтпуск");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ЧтениеОтчетаВыработкаСпециалистов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ЧтениеОтчетовКадровика");
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
